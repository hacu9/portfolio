    ...
    decisions: [
      {
        ...
        body: {
          en: 'A managed platform picks your database, your workers, and your failure modes for you. I wanted those choices back before the product grew into them, so I moved everything onto one Hetzner box running Coolify. When memory ran short I added swap instead of a bigger instance, because a bigger instance would have hidden what the app costs to run. Development runs on that same box: two environments drift, and the drift only ever shows up in the one with users on it. Uptime, disk, and Docker hygiene are mine now.',
