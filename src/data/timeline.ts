...
export const timeline: TimelineEntry[] = [
  {
    ...
    highlights: {
      en: [
        'Principal engineer on the platform API for five years, and the author of 1,084 of its 1,852 commits. It carries 84 data models, 120 migrations, 37 scheduled sync jobs and two admin surfaces.',
        'Owned a separate Python service on Azure that integrates the platform with the client ERP, 58 endpoints, and wrote three quarters of its commits.',
      ...
      es: [
        'Ingeniero principal de la API de la plataforma durante cinco años, y autor de 1.084 de sus 1.852 commits. Tiene 84 modelos de datos, 120 migraciones, 37 trabajos de sincronización programados y dos superficies de administración.',
        'A cargo de un servicio aparte en Python sobre Azure que integra la plataforma con el ERP del cliente, 58 endpoints, y con tres cuartas partes de sus commits míos.',
